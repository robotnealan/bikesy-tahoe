...
const PrivacyPolicy = () => (
  <div>
    ...
    <div className="container">
      ...
      <p>
        {' '}
        BlinkTag Inc built the Bikesy app as an Open Source app. This SERVICE is provided
        by BlinkTag Inc at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Conditions, which is accessible at Bikesy unless otherwise defined in this Privacy
        Policy.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        configuration of the app when utilizing our Service, the time and date of your use
      ...
      <p>
        ...
        to contact us at info@blinktag.com.
      </p>
    </div>
  </div>
);
